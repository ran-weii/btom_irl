...
def parse_args():
    ...
    parser.add_argument("--epsilon", type=float, default=0.1, help="transition error probability, default=0.1")
    # agent args
    ...
    # rollout args
    parser.add_argument("--num_eps", type=int, default=10, help="number of demonstration episodes, default=10")
...
def main(arglist):
    ...
    agent = DiscreteAgent(env.state_dim, env.act_dim, gamma, alpha)
    agent.init_params(log_transition, log_target)
    agent.plan()
