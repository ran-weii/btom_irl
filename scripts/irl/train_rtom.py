...
from src.algo.rtom import RTOM
...
def parse_args():
    ...
    parser.add_argument("--algo", type=str, default="rtom")
    parser.add_argument("--base_yml_path", type=str, default="../../config/irl/rtom/base.yml")
    parser.add_argument("--yml_path", type=str, default="../../config/irl/rtom/hopper-medium-expert-v2.yml")
